...
Test/sctp-multihome2-2Failover instproc init {} {
    $self instvar ns sctp0 testName ftp0 host0_if0 host0_if1 host1_if0 host1_if1 err0 err1 err2 err3 err4 err5
    $self instvar host0_if2 host1_if2 host0_if3 host1_if3 host0_if4 host1_if4 host0_if5 host1_if5 
    ...
    $ns multihome-add-interface $host0_core $host0_if5
	...
	$ns multihome-add-interface $host1_core $host1_if5
	...
	$ns duplex-link $host0_if5 $host1_if5 2Mb 20ms DropTail
   ...
   $ns lossmodel $err1 $host0_if1 $host1_if1
	...
	set err5 [new ErrorModel]
    $ns lossmodel $err5 $host0_if5 $host1_if5
...
$self instvar ns sctp0 host1_if1 host0_if0 host0_if1 sctp0 ftp0 host0_if0 host1_if0 err0 err1 err2 err3 err4 err5
$self instvar host0_if2 host1_if2 host0_if3 host1_if3 host0_if4 host1_if4 host0_if5 host1_if5
...
$ns at 0 "$err0 set rate_ 0.0"

$ns at 0 "$sctp0 set-primary-destination $host1_if5"
...
#$ns at 4 "$err4 set rate_ 1.0"
$ns at 60 "$err4 set rate_ 0.5"
$ns at 67 "$err4 set rate_ 0.0"
$ns at 98 "$err4 set rate_ 0.0"

$ns at 0 "$err5 set rate_ 0.0"
...
$ns at 22 "$ns delay $host0_if2 $host1_if2 10.0ms duplex"
